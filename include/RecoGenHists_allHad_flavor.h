...
class RecoGenHists_allHad_flavor: public uhh2::Hists {
public:
  // use the same constructor arguments as Hists for forwarding:
  RecoGenHists_allHad_flavor(uhh2::Context & ctx, const std::string & dirname,  const std::string & type, double ptreccut_, double ptgencut_, TString flavor_ = "use_both");
...
protected:
  ...
  TH1F *pt_rec, *bIndex;
  TH1F *nsub_before_erase, *nsub_after_erase;
