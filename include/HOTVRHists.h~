...
protected:
    ...
    TH1F *deltaR_bot_jet2, *deltaR_botlep_jet2,*deltaR_q1_jet2, *deltaR_q2_jet2, *deltaR_lep1_jet2, *deltaR_lep2_jet2, *deltaR_tophad_jet2, *deltaR_toplep_jet2, *Reff_HOTVR;
    TH2F *Mass_Reff_HOTVR;
