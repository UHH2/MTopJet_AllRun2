 ...
 */
class MTopJetRecoGenHists: public uhh2::Hists {
public:
    // use the same constructor arguments as Hists for forwarding:
  MTopJetRecoGenHists(uhh2::Context & ctx, const std::string & dirname, const std::string & rec_label, const std::string & gen_label);
