...
import subprocess, os, sys, math, ROOT


# h1*Lumi1+h2*Lumi2/(Lumi1+Lumi2)

def main():
    dir = os.environ["CMSSW_BASE"]+"/src/UHH2/MTopJet/muonSF/"
    ...
    hname = "pt_abseta_ratio"
    file1 = ROOT.TFile(dir+"Muon_Trigger_Eff_SF_BeforeMuonHLTUpdate.root")
    file2 = ROOT.TFile(dir+"Muon_Trigger_Eff_SF_AfterMuonHLTUpdate.root")
    h1 = file1.Get(hdir+hname)
    h2 = file2.Get(hdir+hname)
    Lumi1 = 8.950818835
