...
class SelectionModule3Jets : public ModuleBASE {

 public:
  explicit SelectionModule3Jets(uhh2::Context&);
...
bool SelectionModule3Jets::process(uhh2::Event& event){
...
UHH2_REGISTER_ANALYSIS_MODULE(SelectionModule3Jets)
