#include <UHH2/MTopJet/include/JetCorrections_xcone_V20.h>
...
std::vector<TopJet> set_JEC_factor_V20(std::vector<TopJet> jets){
  Jet new_subjet;
...
JetCorrections_xcone_V20::JetCorrections_xcone_V20(){}

void JetCorrections_xcone_V20::init(uhh2::Context & ctx, const std::string& jet_collection_rec){
...
bool JetCorrections_xcone_V20::process(uhh2::Event & event){
  std::vector<TopJet> jets = event.get(h_topjets);
  event.set(h_topjets, set_JEC_factor_V20(jets)); // first set JEC_factor_raw to a non-0 value
...
JER_Smearer_xcone_V20::JER_Smearer_xcone_V20(){}

void JER_Smearer_xcone_V20::init(uhh2::Context & ctx, const std::string& jet_collection_rec, const std::string& jet_collection_gen, const std::string& fat_sub){
...
bool JER_Smearer_xcone_V20::process(uhh2::Event & event){
  if(use_subjets){
