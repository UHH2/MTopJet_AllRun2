...
MTopJetRecoHists::MTopJetRecoHists(uhh2::Context & ctx, const std::string & dirname, const std::string & jetname): Hists(ctx, dirname){
...
void MTopJetRecoHists::fill(const Event & event){
