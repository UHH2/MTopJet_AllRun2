...
ClusteringHists::ClusteringHists(uhh2::Context & ctx, const std::string & dirname): Hists(ctx, dirname){
  ...
  Top = book<TH2F>("JetDisplay_top", "x=#eta y=#phi", 80, -4 , 4, 50, -M_PI, M_PI);
  Top_lep = book<TH2F>("JetDisplay_toplep", "x=#eta y=#phi", 80, -4 , 4, 50, -M_PI, M_PI);
  Top_had = book<TH2F>("JetDisplay_tophad", "x=#eta y=#phi", 80, -4 , 4, 50, -M_PI, M_PI);
  FatJet1 = book<TH2F>("JetDisplay_pf0", "x=#eta y=#phi", 80, -4 , 4, 50, -M_PI, M_PI);
  FatJet2 = book<TH2F>("JetDisplay_pf1", "x=#eta y=#phi", 80, -4 , 4, 50, -M_PI, M_PI);
  SubJet1_1 = book<TH2F>("JetDisplay_sub1_1", "x=#eta y=#phi", 80, -4 , 4, 50, -M_PI, M_PI);
  SubJet1_2 = book<TH2F>("JetDisplay_sub1_2", "x=#eta y=#phi", 80, -4 , 4, 50, -M_PI, M_PI);
  SubJet1_3 = book<TH2F>("JetDisplay_sub1_3", "x=#eta y=#phi", 80, -4 , 4, 50, -M_PI, M_PI);
  SubJet2_1 = book<TH2F>("JetDisplay_sub2_1", "x=#eta y=#phi", 80, -4 , 4, 50, -M_PI, M_PI);
  SubJet2_2 = book<TH2F>("JetDisplay_sub2_2", "x=#eta y=#phi", 80, -4 , 4, 50, -M_PI, M_PI);
  NotClustered = book<TH2F>("JetDisplay_radiation", "x=#eta y=#phi", 80, -4 , 4, 50, -M_PI, M_PI);
  NotClustered_sub1 = book<TH2F>("JetDisplay_sub1_radiation", "x=#eta y=#phi", 80, -4 , 4, 50, -M_PI, M_PI);
  NotClustered_sub2 = book<TH2F>("JetDisplay_sub2_radiation", "x=#eta y=#phi", 80, -4 , 4, 50, -M_PI, M_PI);
  AllPF = book<TH2F>("JetDisplay_pf_all", "x=#eta y=#phi", 80, -4 , 4, 50, -M_PI, M_PI);
  DecayProducts = book<TH2F>("JetDisplay_decay", "x=#eta y=#phi", 80, -4 , 4, 50, -M_PI, M_PI);
  DecayProducts_lep = book<TH2F>("JetDisplay_decaylep", "x=#eta y=#phi", 80, -4 , 4, 50, -M_PI, M_PI);
  DecayProducts_had = book<TH2F>("JetDisplay_decayhad", "x=#eta y=#phi", 80, -4 , 4, 50, -M_PI, M_PI);
  Bottom_lep = book<TH2F>("JetDisplay_bottomlep", "x=#eta y=#phi", 80, -4 , 4, 50, -M_PI, M_PI);
  Bottom_had = book<TH2F>("JetDisplay_bottomhad", "x=#eta y=#phi", 80, -4 , 4, 50, -M_PI, M_PI);
  Lepton = book<TH2F>("JetDisplay_lepton", "x=#eta y=#phi", 80, -4 , 4, 50, -M_PI, M_PI);
  Neutrino = book<TH2F>("JetDisplay_neutrino", "x=#eta y=#phi", 80, -4 , 4, 50, -M_PI, M_PI);
  LepJet = book<TH2F>("LepJet", "x=#eta y=#phi", 80, -4 , 4, 50, -M_PI, M_PI);
  HadJet = book<TH2F>("HadJet", "x=#eta y=#phi", 80, -4 , 4, 50, -M_PI, M_PI);
  ...
  Eta = book<TH1F>("Eta", "genpartidcle eta", 80, -4, 4);
...
void ClusteringHists::fill(const Event & event){
  ...
  if(!use_int_list){
    ...
    for(unsigned int j=0; j<pf_all.size(); ++j){
      ...
      AllPF->Fill(pf_all.at(j).eta(), phi, pf_all.at(j).energy());
    }  
    for(unsigned int j=0; j<pf_sub1_1.size(); ++j){
      ...
      SubJet1_1->Fill(pf_sub1_1.at(j).eta(), phi, pf_sub1_1.at(j).energy());
    }  
    for(unsigned int j=0; j<pf_sub1_2.size(); ++j){
      ...
      SubJet1_2->Fill(pf_sub1_2.at(j).eta(), phi, pf_sub1_2.at(j).energy());
    } 
    for(unsigned int j=0; j<pf_sub1_3.size(); ++j){
      ...
      SubJet1_3->Fill(pf_sub1_3.at(j).eta(), phi, pf_sub1_3.at(j).energy());
    } 
    for(unsigned int j=0; j<pf_sub2_1.size(); ++j){
      ...
      SubJet2_1->Fill(pf_sub2_1.at(j).eta(), phi, pf_sub2_1.at(j).energy());
    }  
    for(unsigned int j=0; j<pf_sub2_2.size(); ++j){
      ...
      SubJet2_2->Fill(pf_sub2_2.at(j).eta(), phi, pf_sub2_2.at(j).energy());
    } 
    for(unsigned int j=0; j<pf_sub1_0.size(); ++j){
      ...
      NotClustered_sub1->Fill(pf_sub1_0.at(j).eta(), phi, pf_sub1_0.at(j).energy());
    } 
    for(unsigned int j=0; j<pf_sub2_0.size(); ++j){
      ...
      NotClustered_sub2->Fill(pf_sub2_0.at(j).eta(), phi, pf_sub2_0.at(j).energy());
    } 
  }
