...
class MTopJetElecSFModuleCorrelation : public ModuleBASE {

public:
  explicit MTopJetElecSFModuleCorrelation(uhh2::Context&);
...
MTopJetElecSFModuleCorrelation::MTopJetElecSFModuleCorrelation(uhh2::Context& ctx){
...
bool MTopJetElecSFModuleCorrelation::process(uhh2::Event& event){
  if(debug) cout << " ------------------------------------------- " << endl;
  ...
  if(!(pass_elec1 && !pass_elec2)){ // skip low pT trigger
    if(year == Year::is2016v3){
...
UHH2_REGISTER_ANALYSIS_MODULE(MTopJetElecSFModuleCorrelation)
