...
int main(){
  ...
  cout << "   -- Data           2016 & 17 & 18\n";
  cout << "   -- RecoLevel      2016 & 17 & 18\n";
  cout << "   -- GenLevel       2016 & 17 & 18" << endl;
  ...
  for(auto hname: histnames){
    ...
    Plot(h_ttbar, "mc", false, hname);
    Plot(h_data, "data", true, hname+"_NORM");
    Plot(h_ttbar, "mc", true, hname+"_NORM");
  }
