...
int main(int argc, char* argv[]){
  ...
  // read all had uncert
  TString filename = "/nfs/dust/cms/user/paaschal/CMSSW_10_2_X/CMSSW_10_2_10/src/UHH2/MTopJet/CorrectionFile/Correction_SysFromResolution_"+year+".root";
  ...
  c1->SaveAs("/afs/desy.de/user/p/paaschal/Plots/Resolution_Subjets/"+channel+"/ST_pt_"+mean_median+"_"+year+"_noAdditional.pdf");
  ...
  c1->SaveAs("/afs/desy.de/user/p/paaschal/Plots/Resolution_Subjets/"+channel+"/ST_pt_"+mean_median+"_"+year+".pdf");
  ...
  gPad->RedrawAxis();
  c1b->SaveAs("/afs/desy.de/user/p/paaschal/Plots/Resolution_Subjets/"+channel+"/ST_pt_"+mean_median+"_"+year+"_ZOOM.pdf");
  ...
  leg2->Draw();
  gPad->RedrawAxis();
  c2->SaveAs("/afs/desy.de/user/p/paaschal/Plots/Resolution_Subjets/"+channel+"/ST_nonClosure_"+mean_median+"_"+year+".pdf");
