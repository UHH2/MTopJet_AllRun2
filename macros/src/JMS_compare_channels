...
int main(int argc, char* argv[]){
  ...
  TString subdirs        = "btag/rebin180/";
  // vector<TString> fits   = {"masspeak/", "linear/masspeak/"};
  TString fit            = "masspeak/";
  ...
  for(TString mass: masses){
    ...
    if(show_points) cout << " | mass: " << it_mass << endl;
  ...
  if(debug){
    cout << endl;
    cout << "Number Graphs and Ellipses - nom: " << graphs_all_nominal.size() << "   " << ellipse_nominal.size() << endl;
    cout << "Number Graphs and Ellipses - min: " << graphs_all_min.size()     << "   " << ellipse_min.size() << endl;
    cout << "Number Graphs and Ellipses - max: " << graphs_all_max.size()     << "   " << ellipse_max.size() << endl;
  }
  cout << endl;
  ...
  draw(graphs, ellipse, colors, names, "compare_ellipses_masses");
