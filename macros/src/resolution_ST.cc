...
int main(int argc, char* argv[]){
  ...
  TFile* f_tt = new TFile(filedir+year+"/"+channel+"/uhh2.AnalysisModuleRunner.MC.ST_tW.root");
  ...
  // read all had uncert
  TString filename = "/nfs/dust/cms/user/paaschal/CMSSW_10_2_X/CMSSW_10_2_10/src/UHH2/MTopJet/CorrectionFile/Correction_SysFromResolution.root";
