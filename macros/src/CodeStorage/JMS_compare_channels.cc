...
int main(int argc, char* argv[]){
  ...
  cout << "\nExtract Points ... " << endl;
  JMSfactor["Subtraction"] = ExtractFromFile(save_path+"/JetCorrections/Subtraction/fit/combine/combine/100/BinWidth_1/JMS.txt", "combine");
  ...
  TGraph* extrema_sub = graph_multiple_points(JMSfactor["Subtraction"]);
  ...
  TEllipse* ellipse_sub = build_ellipse(JMSfactor["Subtraction"]);
  ...
  draw({extrema_combine, extrema_sub}, {ellipse_combine, ellipse_sub}, {kBlue+2, kRed+2}, {"tt+bkg", "data-bkg"}, "bkg_comparison");
}
