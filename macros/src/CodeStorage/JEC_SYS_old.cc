  ...
  */
  ...
  for(int ptbin=0; ptbin<5; ptbin++){
    ...
    */
    ...
    TH1F   *data_rebin       = RebinHist(data, bin_width);
    ...
    TH1F* ttbar_rebin          = RebinHist(ttbar, bin_width);
    ...
    TH1F* JECup_rebin          = RebinHist(JECup, bin_width);
    TH1F* JECdown_rebin        = RebinHist(JECdown, bin_width);
    TH1F* JECup_rebin_norm     = RebinHist(JECup_norm, bin_width);
    TH1F* JECdown_rebin_norm   = RebinHist(JECdown_norm, bin_width);

    TH1F* XConeup_norm         = normalize(XConeup);
    TH1F* XConedown_norm       = normalize(XConedown);
    TH1F* XConeup_rebin        = RebinHist(XConeup, bin_width);
    TH1F* XConedown_rebin      = RebinHist(XConedown, bin_width);
    TH1F* XConeup_rebin_norm   = RebinHist(XConeup_norm, bin_width);
    TH1F* XConedown_rebin_norm = RebinHist(XConedown_norm, bin_width);
