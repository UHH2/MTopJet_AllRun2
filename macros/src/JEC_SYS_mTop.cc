...
int main(int argc, char* argv[]){
  ...
  */
  ...
  else throw runtime_error("Give me the correct year please (2016, 2017, 2018 or combined) - Start");
  ...
  */
  ...
  for(int ptbin=0; ptbin<4; ptbin++){
    ...
    */
    ...
    vector<double> ttbar_nom_rebin_norm_err = normalize_error(ttbar_nom_rebin);
    ...
    */
    ...
    // #################################################################################################
    // Get TTbar #######################################################################################
    if(debug) cout << "TTbar "+mTop_ << endl;


    TString ttbar_path = "uhh2.AnalysisModuleRunner.MC.TTbar_mtop"+mTop_+".root";
    ...
    */
    ...
    chi2_function->GetHistogram()->GetYaxis()->SetTitle("XCone");
