...
int main(int argc, char* argv[]){
  ...
  int titlefont = 43;
  double ymax = 22.0;
  // if(year == "2016") ymax *= 12;
  // else if(year == "2017") ymax *= 12;
  // else if(year == "2018") ymax *= 59.7/137.1;
  ...
  c->SaveAs("/afs/desy.de/user/s/schwarzd/Plots/Unfolding_Run2/Unfold_"+year+".pdf");
  delete c;
}
