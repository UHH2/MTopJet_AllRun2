...
int main(int argc, char* argv[]){
  ...
  */
  ...
  TString filename;
  filename = dir+"uhh2.AnalysisModuleRunner.MC.TTbar_allHad.root";
  ...
  TString rootname = "files/Correction_allHad.root";
  ...
  A->SaveAs("/afs/desy.de/user/s/schwarzd/Plots/Correction_allHad/Ratio_Mean.pdf");
  ...
  B->SaveAs("/afs/desy.de/user/s/schwarzd/Plots/Correction_allHad/Ptrec_Mean.pdf");
  ...
  C->SaveAs("/afs/desy.de/user/s/schwarzd/Plots/Correction_allHad/Ratio_MEAN_ERR.pdf");
  ...
  D->SaveAs("/afs/desy.de/user/s/schwarzd/Plots/Correction_allHad/Ptrec_MEAN_ERR.pdf");
  ...
  E->SaveAs("/afs/desy.de/user/s/schwarzd/Plots/Correction_allHad/Fits.pdf");
  ...
  for(int pt_bin = 0; pt_bin < no_ptbins; pt_bin++){
    ...
    std::string name = "/afs/desy.de/user/s/schwarzd/Plots/Correction_allHad/Fits_ratio_ptbin";
  ...
  for(int pt_bin = 0; pt_bin < no_ptbins; pt_bin++){
    ...
    std::string name = "/afs/desy.de/user/s/schwarzd/Plots/Correction_allHad/ptrec_mean_ptbin";
    std::string ending = std::to_string(pt_bin) + ".pdf";
  ...
  gPad->RedrawAxis();
  G2->SaveAs("/afs/desy.de/user/s/schwarzd/Plots/Correction_allHad/ptrec_mean_example.pdf");
  ...
  gPad->RedrawAxis();
  G3->SaveAs("/afs/desy.de/user/s/schwarzd/Plots/Correction_allHad/ratio_mean_example.pdf");
  ...
  H->SaveAs("/afs/desy.de/user/s/schwarzd/Plots/Correction_allHad/Event_Count.pdf");
