...
def setTDRStyle(x=0, y=0):
  ...
  tdrStyle.SetOptLogx(x)
  tdrStyle.SetOptLogy(y)
...
def tdrCanvas(canvName, x_min, x_max, y_min, y_max, nameXaxis, nameYaxis, square=kRectangular, iPeriod=4, iPos=11, is2D=False, isExtraSpace=False, logX=0, logY=0):
  ...
  tdrStyle = setTDRStyle(logX, logY)
...
def tdrDiCanvas(canvName, x_min, x_max, y_min, y_max, y_min2, y_max2,  nameXaxis, nameYaxis, nameYaxis2, square = kRectangular, iPeriod = 4, iPos = 11, logX=0, logY=0):
  tdrStyle = setTDRStyle(logX,logY)
