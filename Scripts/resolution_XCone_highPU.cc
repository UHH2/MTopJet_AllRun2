void resolution_XCone_highPU(bool mass)
{
  ...
  if(mass){
    reso[0] = (TH1F*)All->Get("RecGenHists_highPU/MassResolution");
    reso[1] = (TH1F*)All->Get("RecGenHists_highPU/MassResolution_mass1");
    reso[2] = (TH1F*)All->Get("RecGenHists_highPU/MassResolution_mass2");
    reso[3] = (TH1F*)All->Get("RecGenHists_highPU/MassResolution_mass3");
    reso[4] = (TH1F*)All->Get("RecGenHists_highPU/MassResolution_mass4");
    reso[5] = (TH1F*)All->Get("RecGenHists_highPU/MassResolution_mass5");
    reso[6] = (TH1F*)All->Get("RecGenHists_highPU/MassResolution_mass6");

    reso_pt[0] = (TH1F*)All->Get("RecGenHists_highPU/PtResolution");
    reso_pt[1] = (TH1F*)All->Get("RecGenHists_highPU/PtResolution_mass1");
    reso_pt[2] = (TH1F*)All->Get("RecGenHists_highPU/PtResolution_mass2");
    reso_pt[3] = (TH1F*)All->Get("RecGenHists_highPU/PtResolution_mass3");
    reso_pt[4] = (TH1F*)All->Get("RecGenHists_highPU/PtResolution_mass4");
    reso_pt[5] = (TH1F*)All->Get("RecGenHists_highPU/PtResolution_mass5");
    reso_pt[6] = (TH1F*)All->Get("RecGenHists_highPU/PtResolution_mass6");

    reso_noJEC[0] = (TH1F*)All->Get("RecGenHists_highPU_noJEC/MassResolution");
    reso_noJEC[1] = (TH1F*)All->Get("RecGenHists_highPU_noJEC/MassResolution_mass1");
    reso_noJEC[2] = (TH1F*)All->Get("RecGenHists_highPU_noJEC/MassResolution_mass2");
    reso_noJEC[3] = (TH1F*)All->Get("RecGenHists_highPU_noJEC/MassResolution_mass3");
    reso_noJEC[4] = (TH1F*)All->Get("RecGenHists_highPU_noJEC/MassResolution_mass4");
    reso_noJEC[5] = (TH1F*)All->Get("RecGenHists_highPU_noJEC/MassResolution_mass5");
    reso_noJEC[6] = (TH1F*)All->Get("RecGenHists_highPU_noJEC/MassResolution_mass6");

    reso_pt_noJEC[0] = (TH1F*)All->Get("RecGenHists_highPU_noJEC/PtResolution");
    reso_pt_noJEC[1] = (TH1F*)All->Get("RecGenHists_highPU_noJEC/PtResolution_mass1");
    reso_pt_noJEC[2] = (TH1F*)All->Get("RecGenHists_highPU_noJEC/PtResolution_mass2");
    reso_pt_noJEC[3] = (TH1F*)All->Get("RecGenHists_highPU_noJEC/PtResolution_mass3");
    reso_pt_noJEC[4] = (TH1F*)All->Get("RecGenHists_highPU_noJEC/PtResolution_mass4");
    reso_pt_noJEC[5] = (TH1F*)All->Get("RecGenHists_highPU_noJEC/PtResolution_mass5");
    reso_pt_noJEC[6] = (TH1F*)All->Get("RecGenHists_highPU_noJEC/PtResolution_mass6");
  }
  else{
    reso[0] = (TH1F*)All->Get("RecGenHists_highPU/MassResolution");
    reso[1] = (TH1F*)All->Get("RecGenHists_highPU/MassResolution_pt1");
    reso[2] = (TH1F*)All->Get("RecGenHists_highPU/MassResolution_pt2");
    reso[3] = (TH1F*)All->Get("RecGenHists_highPU/MassResolution_pt3");
    reso[4] = (TH1F*)All->Get("RecGenHists_highPU/MassResolution_pt4");
    reso[5] = (TH1F*)All->Get("RecGenHists_highPU/MassResolution_pt5");
    reso[6] = (TH1F*)All->Get("RecGenHists_highPU/MassResolution_pt6");

    reso_pt[0] = (TH1F*)All->Get("RecGenHists_highPU/PtResolution");
    reso_pt[1] = (TH1F*)All->Get("RecGenHists_highPU/PtResolution_pt1");
    reso_pt[2] = (TH1F*)All->Get("RecGenHists_highPU/PtResolution_pt2");
    reso_pt[3] = (TH1F*)All->Get("RecGenHists_highPU/PtResolution_pt3");
    reso_pt[4] = (TH1F*)All->Get("RecGenHists_highPU/PtResolution_pt4");
    reso_pt[5] = (TH1F*)All->Get("RecGenHists_highPU/PtResolution_pt5");
    reso_pt[6] = (TH1F*)All->Get("RecGenHists_highPU/PtResolution_pt6");

    reso_noJEC[0] = (TH1F*)All->Get("RecGenHists_highPU_noJEC/MassResolution");
    reso_noJEC[1] = (TH1F*)All->Get("RecGenHists_highPU_noJEC/MassResolution_pt1");
    reso_noJEC[2] = (TH1F*)All->Get("RecGenHists_highPU_noJEC/MassResolution_pt2");
    reso_noJEC[3] = (TH1F*)All->Get("RecGenHists_highPU_noJEC/MassResolution_pt3");
    reso_noJEC[4] = (TH1F*)All->Get("RecGenHists_highPU_noJEC/MassResolution_pt4");
    reso_noJEC[5] = (TH1F*)All->Get("RecGenHists_highPU_noJEC/MassResolution_pt5");
    reso_noJEC[6] = (TH1F*)All->Get("RecGenHists_highPU_noJEC/MassResolution_pt6");

    reso_pt_noJEC[0] = (TH1F*)All->Get("RecGenHists_highPU_noJEC/PtResolution");
    reso_pt_noJEC[1] = (TH1F*)All->Get("RecGenHists_highPU_noJEC/PtResolution_pt1");
    reso_pt_noJEC[2] = (TH1F*)All->Get("RecGenHists_highPU_noJEC/PtResolution_pt2");
    reso_pt_noJEC[3] = (TH1F*)All->Get("RecGenHists_highPU_noJEC/PtResolution_pt3");
    reso_pt_noJEC[4] = (TH1F*)All->Get("RecGenHists_highPU_noJEC/PtResolution_pt4");
    reso_pt_noJEC[5] = (TH1F*)All->Get("RecGenHists_highPU_noJEC/PtResolution_pt5");
    reso_pt_noJEC[6] = (TH1F*)All->Get("RecGenHists_highPU_noJEC/PtResolution_pt6");
  }
  ...
  leg->Draw();
  gPad->RedrawAxis();
  if(mass)c1->SaveAs("/afs/desy.de/user/s/schwarzd/Plots/resolution_highPU_mass_mean_massbin.pdf"); 
  else c1->SaveAs("/afs/desy.de/user/s/schwarzd/Plots/resolution_highPU_mass_mean_ptbin.pdf"); 
  ...
  leg2->Draw();
  gPad->RedrawAxis();
  if(mass)c2->SaveAs("/afs/desy.de/user/s/schwarzd/Plots/resolution_highPU_pt_mean_massbin.pdf"); 
  else c2->SaveAs("/afs/desy.de/user/s/schwarzd/Plots/resolution_highPU_pt_mean_ptbin.pdf"); 
  ...
  leg3->Draw();
  gPad->RedrawAxis();
  if(mass)c3->SaveAs("/afs/desy.de/user/s/schwarzd/Plots/resolution_highPU_mass_rms_massbin.pdf"); 
  else c3->SaveAs("/afs/desy.de/user/s/schwarzd/Plots/resolution_highPU_mass_rms_ptbin.pdf"); 
  ...
  leg4->Draw();
  gPad->RedrawAxis();
  if(mass)c4->SaveAs("/afs/desy.de/user/s/schwarzd/Plots/resolution_highPU_pt_rms_massbin.pdf"); 
  else c4->SaveAs("/afs/desy.de/user/s/schwarzd/Plots/resolution_highPU_pt_rms_ptbin.pdf"); 
